...
String[] plot=MongodbBean.getBook_bplot();
...
<body  style="background-color: #F2F2F2;">
 <table width="100%" height="79" border="0" cellpadding="0" cellspacing="0" align=center>
       <tr>
        ...
        <tr><td align="center" style="font-size:60px;color: white;"> 简单图书系统</td></tr> 
        </table>
        </td>
       </tr>
       ...
       <div align="right">
         <form action="stu_search.jsp" method="post" >
...
%>
  <tr>
    ...
    <td><a href="stu_look.jsp?bid=<%=id[i]%>&bnumber=<%=number[i]%>&btype=<%=type[i]%>&bname=<%=name[i]%>&bplot=<%=plot[i]%>>">查看</a></td>
  </tr>
<%            
       }
 %>       
